%% Check ICA components and remove blink components one subject at a time (semi-auto method)
% Last modified by Hause Lin 15-08-18 13:46 hauselin@gmail.com

%% Set up parameters and read data

clear, clc, close all
subject = '053'; % subject id
...
% Remove ICA components and compare results
